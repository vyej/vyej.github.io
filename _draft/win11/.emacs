				...
				(lambda (frame)
				  (with-selected-frame frame
					(set-fontset-font "fontset-default"
									  'unicode "Microsoft YaHei 16"))))
(set-fontset-font "fontset-default" 'unicode "Microsoft YaHei 16"))
...
(setq org-capture-templates
      '(
        ("j" "Journal" entry (file+datetree "~/vyej.github.io/orgs/excerpts.org")
         "* %?\nEntered on %U\n  %i\n  %a")
	("c" "codas" entry (file+datetree "~/vyej.github.io/orgs/codas.org")
         "* %?\nEntered on %U\n  %i\n  %a")
...
(set-frame-position (selected-frame) 30 40)
