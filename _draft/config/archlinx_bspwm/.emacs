;;hy's emacs @archlinux 測試中文！@#￥ oak可以應該
				...
				(lambda (frame)
				  (with-selected-frame frame
					(set-fontset-font "fontset-default"
									  'unicode "Source Han Serif CN 14"))))
(set-fontset-font "fontset-default" 'unicode "Source Han Serif Light 14"))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (emms htmlize ox-html5slide markdown-mode ess elpy auctex))))
