				...
				(lambda (frame)
				  (with-selected-frame frame
					(set-fontset-font "fontset-default"
									  'unicode "Hannotate 16"))))
(set-fontset-font "fontset-default" 'unicode "Hannotate 16"))
...
(setq org-capture-templates
	 ...
	 "* %? Entered on %U %i %a") 
	("r" "runing" entry (file+datetree "~/vyej.github.io/orgs/runin.org")
	 "* %? Entered on %U %i %a")))
